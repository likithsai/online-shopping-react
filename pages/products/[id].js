    ...
    useEffect(() => {
        fetchData('/api/getproducts', { 'productid': id }, (data) => {
            ...
            if (Object.keys(data.message.filteredProducts).length !== 0){
                ...
                setItemDescShort(data.message.filteredProducts[0].itemdescshort);
            ...
            <div className="products">
                ...
                <main>
                        ...
                        <div className="container px-4 px-lg-5 my-5">
                            <div className="row gx-4 gx-lg-5 align-items-center">
                                ...
                                <div className="col-md-6">
                                    <h1 className="display-5 fw-bolder">{itemName}</h1>
                                    <div className="w-100 fs-5 mb-5 mt-2">
                                        <span className="fw-bold me-2 h2">{ itemCurrency[0].baseCurrencySymbol + itemNewPrice }</span>
                                        <span className="text-muted text-decoration-line-through me-2">{ itemCurrency[0].baseCurrencySymbol + itemOldPrice }</span>
                                        <span className="me-2 text-success">{Math.round((itemOldPrice - itemNewPrice)/itemNewPrice * 100)}% off</span>
                                    </div>
                    ...
                    <section className="pt-3 pb-5">
                        <div className="container px-4 px-lg-5 my-5" dangerouslySetInnerHTML={{ __html: itemDescLong }}></div>
                    </section>
